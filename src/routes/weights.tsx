...
function WeightsPage() {
  ...
  return (
    <div className="bg-black text-white font-sans relative min-h-screen pb-page-nav overflow-x-hidden">
      ...
      <div className="relative h-[35vh] pointer-events-none overflow-hidden">
        ...
        <div className="relative flex flex-col justify-end h-full px-4 pt-12">
          <div className="max-w-md mx-auto w-full">
            <h1 className="text-5xl font-bold tracking-tighter text-orange-500 break-words">
              Weights
            </h1>
          </div>
        </div>
      ...
      <button
        ...
        className="fixed bottom-fab-safe right-6 h-16 w-16 bg-linear-to-tr from-orange-500 to-rose-600 rounded-full flex items-center justify-center shadow-lg shadow-orange-900/40 text-white z-40 hover:scale-105 active:scale-95 transition-all outline-hidden ring-4 ring-orange-500/10"
      >
