        ...
        {bottomNavItems.map((item) => {
          ...
          return (
            <Link
              ...
              viewTransition
              className={cn(
                "inline-flex min-h-11 min-w-11 items-center justify-center transition-colors rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900",
