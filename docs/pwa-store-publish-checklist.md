...
**Last completed batch:** F — `fa2e2a3` (2026-06-24)
...
- [x] Capacitor chosen over PWABuilder — `docs/ios-capacitor.md` — `fa2e2a3`
- [x] Minimal Capacitor scaffold (`capacitor.config.ts`, `ios/`, shared icons via `npm run ios:sync-assets`) — `fa2e2a3`
