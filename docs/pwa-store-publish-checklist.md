...
**Last completed batch:** C (`b57e9d4`)
...
- [x] `/privacy` page with store-ready privacy policy — `b57e9d4`
- [x] `/terms` page with terms of service — `b57e9d4`
- [x] Links from settings / install flows — `b57e9d4`
...
- Batches A–B were completed on branch `cursor/nyx-fit-pwa-checklist-af1a`; cherry-pick or re-apply before marking Phase 1.
