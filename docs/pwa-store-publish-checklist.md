...
**Last completed batch:** C — `413e561` (2026-06-24)
...
- [x] `/privacy` page with store-ready privacy policy — `413e561`
- [x] `/terms` page with terms of service — `413e561`
- [x] Links from settings / install flows — `413e561`
